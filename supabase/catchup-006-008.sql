-- Safe to re-run: applies migrations 006, 007, 008 if your remote DB is behind.
-- Run in Supabase Dashboard → SQL Editor, or: npm run db:catchup (needs SUPABASE_DB_PASSWORD)

-- 006_alert_rls_dedup_lock.sql
...
-- 007_phase1_observability_rate_limits.sql
